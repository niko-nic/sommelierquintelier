          ...
          content: (
            <>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                ...
                or by contacting sommelier@yentlquintelier.com. Upon cancellation, the subscription is immediately cancelled and 
          ...
          content: (
            <>
              <p className="text-muted-foreground leading-relaxed">
                ...
                Complaints about products must be reported within 7 days of receipt via sommelier@yentlquintelier.com
              </p>
              <p className="text-muted-foreground leading-relaxed mt-4">
          ...
          content: (
            <>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                ...
                VAT: BE1025083231<br />
                Belgium<br />
                Email: <a href="mailto:sommelier@yentlquintelier.com" className="text-primary hover:underline">sommelier@yentlquintelier.com</a>
              </p>
            </>
          ),
        },
          ...
          content: (
            <>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                ...
                ou en contactant sommelier@yentlquintelier.com. Lors de l'annulation, l'abonnement est immédiatement annulé et 
          ...
          content: (
            <>
              <p className="text-muted-foreground leading-relaxed">
                ...
                Les réclamations concernant les produits doivent être signalées dans les 7 jours suivant la réception via sommelier@yentlquintelier.com
              </p>
              <p className="text-muted-foreground leading-relaxed mt-4">
        ...
        content: (
          <>
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              ...
              of door contact op te nemen met sommelier@yentlquintelier.com. Bij opzegging wordt het abonnement direct geannuleerd en 
        ...
        content: (
          <>
            <p className="text-muted-foreground leading-relaxed">
              ...
              Klachten over producten dienen binnen 7 dagen na ontvangst gemeld te worden via sommelier@yentlquintelier.com
            </p>
            <p className="text-muted-foreground leading-relaxed mt-4">
        ...
        content: (
          <>
            ...
            <p className="text-muted-foreground leading-relaxed mt-4">
              ...
              BTW: BE1025083231<br />
              België<br />
              E-mail: <a href="mailto:sommelier@yentlquintelier.com" className="text-primary hover:underline">sommelier@yentlquintelier.com</a>
            </p>
          </>
        ),
      },
